# Module 1 Project 1: Flashcards

This project walks through creating a small trivia game in the terminal. It practices creating and using classes and embedding objects within each other. 
